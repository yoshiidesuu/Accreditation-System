...
@section('page-title', 'Create New Parameter')
@section('page-description', 'Add a new form parameter to an area')
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="fas fa-plus me-2"></i>Parameter Information
                </h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('user.parameters.store') }}" id="parameterForm">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  placeholder="Describe what this parameter is for...">{{ old('description') }}</textarea>
                        @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="min_length" 
                                                   name="validation_rules[min_length]" value="{{ old('validation_rules.min_length') }}" min="0">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="max_length" 
                                                   name="validation_rules[max_length]" value="{{ old('validation_rules.max_length') }}" min="0">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="min_value" 
                                                   name="validation_rules[min_value]" value="{{ old('validation_rules.min_value') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="max_value" 
                                                   name="validation_rules[max_value]" value="{{ old('validation_rules.max_value') }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="max_file_size" 
                                                   name="validation_rules[max_file_size]" value="{{ old('validation_rules.max_file_size', 2) }}" min="1">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="allowed_extensions" 
                                                   name="validation_rules[allowed_extensions]" value="{{ old('validation_rules.allowed_extensions') }}" 
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <a href="{{ route('user.parameters.index') }}" class="btn btn-secondary">
